...
public final class ResultFactory
{
    ...
    public static <T> Result<T> failure(T newPayload, Result originalResult)
    {
        return failure(newPayload, originalResult.getMessage(), originalResult.getFailureType(), originalResult.getStacktrace());
    }
