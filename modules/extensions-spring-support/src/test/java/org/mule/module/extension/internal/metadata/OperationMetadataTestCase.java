...
import static org.mule.module.extension.internal.runtime.metadata.MetadataMediator.MESSAGE_ATTRIBUTES_NAME;
...
public class OperationMetadataTestCase extends MetadataExtensionFunctionalTestCase
{
    ...
    public static final String MESSAGE_ATTRIBUTES_PERSON_TYPE_METADATA = "messageAttributesPersonTypeMetadata";
    public static final String MESSAGE_ATTRIBUTES_NULL_TYPE_METADATA = "messageAttributesNullTypeMetadata";
    ...
    public void messageAttributesNullTypeMetadata() throws Exception
    {
        ...
        final OperationMetadataDescriptor metadataDescriptor = getOperationStaticMetadata();
        assertExpectedParam(metadataDescriptor.getAttributesMetadata(), MESSAGE_ATTRIBUTES_NAME, void.class, false);
    ...
    {
        processorId = new ProcessorId(MESSAGE_ATTRIBUTES_PERSON_TYPE_METADATA, FIRST_PROCESSOR_INDEX);

        final OperationMetadataDescriptor metadataDescriptor = getOperationDynamicMetadata();
        assertExpectedParam(metadataDescriptor.getAttributesMetadata(), MESSAGE_ATTRIBUTES_NAME, String.class, false);
